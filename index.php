    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#facts">FUN STATS</a></li>
    ...
    <div id="recommendations" class="section">
      <div class="container">
        ...
        <ul class="section-info" tabindex="-1">
          <li id="ember1110" ng-repeat="(person, data) in resume_data.endorsements"
            class="pv-recommendation-entity ember-view">
            <div id="{{person}}" class="pv-recommendation-entity__header">
              <a data-control-name="recommendation_details_profile" href="{{data[0].linkedIn_URL}}" id="ember1111"
                ...
                <img src="{{data[0].image}}" loading="lazy" width="110" height="110" alt="{{person}}"
                ...
                <div class="pv-recommendation-entity__detail">
                  ...
                  <p class="pv-recommendation-entity__headline t-14 t-black t-normal pb1" ng-bind-html="data[0].title">
                  </p>
                  <p class="t-12 t-black--light t-normal">{{data[0].date_association}}
                    at<br>{{data[0].endorsed_for_company}}</p>
                </div>
              </a></div>
          ...
          <div class="col-md-4">
            ...
            <div class="row">
              <iframe height='160' width='300' frameborder='0' allowtransparency='true' scrolling='no'
                src='https://www.strava.com/athletes/64076709/activity-summary/6915282591d0ef55e0ec369675331f1ef35ff17b'></iframe>
            </div>
            <div class="row">
              <iframe height='500' width='300' frameborder='0' allowtransparency='true' scrolling='yes'
                src='https://www.strava.com/athletes/64076709/latest-rides/6915282591d0ef55e0ec369675331f1ef35ff17b'></iframe>
            </div>
          </div>
          <div class="col-md-4">
            <h3>Spotify Playlist</h3>
            <iframe src="https://open.spotify.com/embed/playlist/1mtETWxPq2toMoResmso4I" width="300" height="620"
